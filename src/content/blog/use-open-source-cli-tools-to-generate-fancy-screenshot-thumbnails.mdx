...
Below this section are some examples followed by some excerpts from the README.md page created for the Github repo. So, if you spot these cover images across my site over the coming weeks and months, then I guess it passed the 'hopelessly easy to use' test!
...
<Gallery 
  dir="galleries/magick-tricks/source-inputs" 
  alt="Screenshot showing Magick Tricks effects"
  layout="triple"
  gap="small"
  padding="small"
/>
...
<Gallery
  dir="galleries/magick-tricks/perspective" 
  alt="Source input screenshots"
  layout="double"
  gap="small"
  padding="small"
/>

### Horizontal mirrored Tilt Effect

<Gallery
  dir="galleries/magick-tricks/mirrortilt" 
  alt="Source input screenshots"
  layout="double"
  gap="small"
  padding="small"
...
<Gallery
  dir="galleries/magick-tricks/elements" 
  alt="Source input screenshots"
  layout="double"
  gap="small"
  padding="small"
