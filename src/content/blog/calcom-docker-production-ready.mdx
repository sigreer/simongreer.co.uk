...
description: "Deploy cal.com (Calendso) in production using Docker"
pubDate: 2024-11-19
status: "published"
slug: "calcom-docker-production-ready"
coverimage: "calcom-pixel-booking-graphic.webp"
...
The app is very slick and modern. The self-hostable open source version is powered by Next.js 13 with React and Tailwind UI components and styling. Under the hood is Postgres with Prisma ORM sat in front of it. It uses tRPC API, and Prisma as the ORM which is powered by a Postgres DB. There's also mention of 'daily.co', which I'd never heard of before but it looks like it's only available for enterprise/SaaS customers as an integrated voice and video-conferencing solution.
