...
description: |
  A long term project to design and develop a series of embedded devices powered by Linux to manage and control live television broadcasts.
  There were three separate hardware devices each with their own custom builds of Ubuntu XFCE as well as a comprehensive set of shell scripts to automate and manage the device.
  Each device also had its own purpose-built desktop application for managing the broadcasts  which was written in Flutter/Dart.scripts and its own desktop application written in Flutter/Dart to execute its  needed custom builds of Ubuntu XFCE. Each system was fitted with "
pubDate: 2024-10-30
status: published
