...
function isContentCollectionsCacheEnabled(settings) {
  return settings.config.experimental.contentCollectionCache && // contentCollectionsCache is an SSG only feature
