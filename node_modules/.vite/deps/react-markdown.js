      ...
      function createEnumTypeChecker(expectedValues) {
        ...
        function validate(props, propName, componentName, location, propFullName) {
          ...
          for (var i = 0; i < expectedValues.length; i++) {
            if (is4(propValue, expectedValues[i])) {
              return null;
            }
          }
...
// node_modules/react-markdown/node_modules/vfile/node_modules/vfile-message/lib/index.js
...
// node_modules/unified/node_modules/vfile/node_modules/vfile-message/lib/index.js
...
var path2 = { basename: basename2, dirname: dirname2, extname: extname2, join: join2, sep: "/" };
...
function normalize2(path3) {
  assertPath3(path3);
  const absolute = path3.charCodeAt(0) === 47;
  let value = normalizeString2(path3, !absolute);
  if (value.length === 0 && !absolute) {
    value = ".";
  }
  if (value.length > 0 && path3.charCodeAt(path3.length - 1) === 47) {
...
function urlToPath2(path3) {
  if (typeof path3 === "string") {
    path3 = new URL(path3);
  } else if (!isUrl2(path3)) {
    const error = new TypeError(
      'The "path" argument must be of type string or an instance of URL. Received `' + path3 + "`"
    );
    error.code = "ERR_INVALID_ARG_TYPE";
  ...
  return getPathFromURLPosix2(path3);
}
...
var VFile2 = class {
  ...
  set dirname(dirname3) {
    ...
    this.path = path2.join(dirname3 || "", this.basename);
  }
  /**
   * Get the basename (including extname) (example: `'index.min.js'`).
   */
  ...
  set basename(basename3) {
    ...
    this.path = path2.join(this.dirname || "", basename3);
  }
  /**
   * Get the extname (including dot) (example: `'.js'`).
   */
  ...
  set extname(extname3) {
    ...
    this.path = path2.join(this.dirname, this.stem + (extname3 || ""));
  }
  /**
   * Get the stem (basename w/o extname) (example: `'index.min'`).
   */
...
function assertPath4(path3, name) {
  if (!path3) {
    throw new Error("Setting `" + name + "` requires `path` to be set too");
  }
}
function buffer2(value) {
  return (0, import_is_buffer2.default)(value);
}
...
function looksLikeAVFileValue(value) {
  return typeof value === "string" || (0, import_is_buffer3.default)(value);
}
...
// node_modules/micromark-core-commonmark/node_modules/micromark-util-classify-character/dev/index.js
...
function tokenizeCodeFenced(effects, ok4, nok) {
  ...
  function infoBefore(code2) {
    if (code2 === codes.eof || markdownLineEnding(code2)) {
      ...
      return self.interrupt ? ok4(code2) : effects.check(nonLazyContinuation, atNonLazyBreak, after)(code2);
    }
...
function tokenizeNonLazyContinuation(effects, ok4, nok) {
  ...
  function lineStart(code2) {
    return self.parser.lazy[self.now().line] ? nok(code2) : ok4(code2);
  }
}
...
function tokenizeContinuation(effects, ok4, nok) {
  ...
  function prefixed(code2) {
    ...
    return effects.interrupt(self.parser.constructs.flow, nok, ok4)(code2);
  }
}
...
function tokenizeHtmlFlow(effects, ok4, nok) {
  ...
  function tagName(code2) {
    if (code2 === codes.eof || code2 === codes.slash || code2 === codes.greaterThan || markdownLineEndingOrSpace(code2)) {
      ...
      const name = buffer3.toLowerCase();
      if (!slash && !closingTag && htmlRawNames.includes(name)) {
        marker = constants.htmlRaw;
        return self.interrupt ? ok4(code2) : continuation(code2);
      }
  ...
  function continuationRawEndTag(code2) {
    ...
    if (asciiAlpha(code2) && buffer3.length < constants.htmlRawSizeMax) {
      effects.consume(code2);
      buffer3 += String.fromCharCode(code2);
      return continuationRawEndTag;
    }
...
function tokenizeLabelStartImage(effects, ok4, nok) {
  ...
  function after(code2) {
    return code2 === codes.caret && "_hiddenFootnoteSupport" in self.parser.constructs ? nok(code2) : ok4(code2);
  }
}
...
function tokenizeIndent(effects, ok4, nok) {
  ...
  function afterPrefix(code2) {
    ok(self.containerState, "expected state");
    const tail = self.events[self.events.length - 1];
    return tail && tail[1].type === types.listItemIndent && tail[2].sliceSerialize(tail[1], true).length === self.containerState.size ? ok4(code2) : nok(code2);
  }
}
...
// node_modules/mdast-util-to-hast/node_modules/unist-util-visit/node_modules/unist-util-is/lib/index.js
var convert = (
  /**
   * @type {(
...
// node_modules/mdast-util-to-hast/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/color.browser.js
function color(d) {
  return d;
}

// node_modules/mdast-util-to-hast/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/index.js
var CONTINUE = true;
var EXIT = false;
var SKIP = "skip";
var visitParents = (
...
// node_modules/react-markdown/node_modules/unist-util-visit/node_modules/unist-util-is/lib/index.js
var convert2 = (
  /**
   * @type {(
   *   (<Kind extends Node>(test: PredicateTest<Kind>) => AssertPredicate<Kind>) &
...
// node_modules/react-markdown/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/color.browser.js
function color2(d) {
  return d;
}

// node_modules/react-markdown/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/index.js
var CONTINUE2 = true;
var EXIT2 = false;
var SKIP2 = "skip";
var visitParents2 = (
...
function rehypeFilter(options) {
  ...
  if (options.allowedElements || options.disallowedElements || options.allowElement) {
    return (tree) => {
      visit2(tree, "element", (node2, index2, parent_) => {
        const parent = (
          /** @type {Element|Root} */
          parent_
        );
